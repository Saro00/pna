...
"""
from nets.PCBA_graph_classification.eig_net import EIGNet
from data.PCBA import PCBADataset  # import dataset
from train.train_PCBA_graph_classification import train_epoch_sparse as train_epoch, evaluate_network_sparse as evaluate_network
        ...
        with tqdm(range(params['epochs']), unit='epoch') as t:
            for epoch in t:
                ...
                t.set_postfix(time=time.time() - start, lr=optimizer.param_groups[0]['lr'],
                              ...
                              train_AP=epoch_train_ap, val_AP=epoch_val_ap.item(),
...
def main():
    ...
    print('ok')
    print(DATASET_NAME)
    dataset = PCBADataset(DATASET_NAME)
